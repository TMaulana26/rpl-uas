...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-primary">
    <div class="container">
      <a class="navbar-brand text-dark" href="index.php"><strong class="text-warning">UNSIKA</strong> SHOP</a>
  ...
  <div class="container">
    ...
    <img class="img_bg" src="./images/BG.jpeg" alt="....">
    <div class="row">
